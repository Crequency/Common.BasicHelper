...
public struct Version
{
    ...
    public List<Architecture> SupportedArchitectures => new();

    public List<Platform> SupportedPlatforms => new();
    ...
    {
        var regex = new Regex(RegexStrings.Version_Parse_STR);
        var collection = regex.Matches(version);
